package com.ayeshaazeema.quezzz.fragment
...
import com.ayeshaazeema.quezzz.databinding.FragmentQuizBinding
import com.ayeshaazeema.quezzz.model.Quiz
...
class QuizFragment : Fragment() {
    ...
    private fun setNumberQuestion() {
        ...
        (activity as AppCompatActivity).supportActionBar?.title =
            getString(R.string.title_quezzz, questionIndex + 1, numberIndicatorQuestion)
    }
}